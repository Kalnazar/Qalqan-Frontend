...
const Form = () => {
  ...
  return (
    <div className="bg-primary px-10 py-15 rounded-3xl">
      ...
      <div className="flex mt-8 justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <label className="text-white font-medium text-base" htmlFor="accept">
      ...
      <div className="mt-8 flex flex-col gap-4">
        <button
          ...
          className="bg-button text-white text-lg font-bold button-custom"
        >
          Sign in
        </button>
      ...
      <div className="mt-8 flex justify-center items-center gap-2">
        ...
        <button className="text-secondary text-base underline">Sign up</button>
      </div>
    </div>
  );
};
